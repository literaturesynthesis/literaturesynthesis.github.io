...
`.deb` file for Ubuntu version. If you have an older version 
of Ubuntu (e.g. 16.04), visit this page: https://www.rstudio.com/products/rstudio/older-versions/
...
## Install RStudio Desktop ----
sudo dpkg -i rstudio-2022.02.3-492-amd64.deb     # Ubuntu 22.04 LTS only
# sudo dpkg -i rstudio-2022.02.1-461-amd64.deb   # Ubuntu >= 18.04 LTS
# sudo dpkg -i rstudio-1.4.1106-amd64.deb        # Ubuntu 16.04 LTS only
